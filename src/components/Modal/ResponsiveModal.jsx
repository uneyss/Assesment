...
const Modal = ({ data, id, closeModal }) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center p-6 gap-4 absolute  bg-[#FFFFFF] gray-200 z-10 ml-[25rem] mt-[25rem] w-[37.25rem] h-[35.625rem] 
    sm:ml-[0rem] mt-[0rem] w-[27.75rem] h-[64rem]">
        {/* Content */} 
      <div className="flex flex-col items-start p-6 gap-5 w-[34.25rem] h-[34.625rem] flex-none order-none self-stretch grow-0 
      sm:w-[24.75rem] h-[30rem] ">
        ...
        <div className="flex flex-col items-start p-0 gap-2 flex-none order-1 self-stretch grow-0 
        sm:w-[24.75rem]">
          ...
          <p className="w-[34.25rem] h-[5rem] font-roboto font-medium text-sm text-center text-[#111729] flex-none order-1 slef-stretch grow-0 
          sm:w-[24.75rem] h-[6.25rem]">
        ...
        {/* Button */} 
        <div className="flex flex-row justify-center items-center py-3 px-5 gap-2 w-[34.25rem] h-[3rem] bg-[#0049E6] text-[#FFFFFF] font-roboto shadow-sm rounded-lg flex-none order-5 self-stretch grow-0 
        sm:w-[21.75rem]">
